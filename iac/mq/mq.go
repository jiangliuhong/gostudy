...
{
	"name": "test",
	"playbook": "git::https://gitlab.yun.shop/jiangliuhong/vmware-demo.git/backup/playbook.yml",
	"playbookEnv": {
		"groups": [
			{
				"name": "cmp",
				"hosts": [
					{
						"ip": "cmp-510308-core.yun.idcos"
					}
				]
			}
		],
		"username": "root",
		"privateKey": "path::~/.ssh/aliyun-key",
        "extraVars":{
            "name":"temp22"
        }
	}
