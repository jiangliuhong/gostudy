...
func (c *userServiceClient) Search(ctx context.Context, in *UserSearchRequest, opts ...grpc.CallOption) (*UserSearchResponse, error) {
...
func (UnimplementedUserServiceServer) Search(context.Context, *UserSearchRequest) (*UserSearchResponse, error) {
